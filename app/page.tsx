...
const HomePage = () => {
  ...
  <div className='ml-5 mr-5 flex flex-col justify-items-center gap-5'>
    <div className="flex flex-row gap-5 items-stretch justify-items-center">
      <div className="bg-surface border border-bordercolor rounded-lg p-5 flex-1">
        ...
        <div className="flex flex-row mt-5">
          ...
          <span className={`font-mono text-xs ${readBooksDiffMonth > 0 ? "text-emerald" : readBooksDiffMonth < 0 ? "text-oxblood" : "text-amber" }`}>
            ...
            <span className="text-xs text-muted"> 
              vs April &middot; { Math.floor((readBooks / goalBooks) * 100)}% of goal 
          </span>
        </div>
    ...
    <div className="flex flex-row gap-5 items-stretch justify-items-center">
      <div className="bg-surface border border-bordercolor rounded-lg p-5 flex-1">
        <h2 className="text-muted font-mono uppercase tracking-wider-than-widest text-textsmall">Monthly Calendar: In Progress</h2>
      </div>
      <div className="bg-surface border border-bordercolor rounded-lg p-5 flex-1">
